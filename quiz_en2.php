...
<div class="height"></div>
    <div id = "imageListId"> 
         <div id="imageNod8ff00" class = "listitemClass"> 
          ...
          <br>
        <div id="imageNod2ff00" class = "listitemClass"> 
            <img src="img/zestaw2/d2ff00.png" alt=""> d2ff00
        </div> 
          <br>
        <div id="imageNof0ff00" class = "listitemClass"> 
            <img src="img/zestaw2/f0ff00.png" alt=""> f0ff00
        </div> 
          <br>
        <div id="imageNoeafff00" class = "listitemClass"> 
            <img src="img/zestaw2/eaff00.png" alt=""> eaff00
        </div><br>
		<div id="imageNodeff00" class = "listitemClass"> 
...
kolejnosc = document.getElementById("outputvalues").value;
 grading = ["d2ff00", "d8ff00", "e4ff00", "eaff00", "f0ff00", "deff00"];
...
document.getElementById("zestaw").value = "zestaw2";
