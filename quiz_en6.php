...
<div class="height"></div>
    <div id = "imageListId"> 
         <div id="imageNo1fff00" class = "listitemClass"> 
          ...
          <br>
		  <div id="imageNo92ff00" class = "listitemClass"> 
            <img src="img/zestaw6/92ff00.png" alt=""> 92ff00
        </div> 
          <br>
        <div id="imageNo5eff00" class = "listitemClass"> 
        ...
        <div id="imageNo00ff92" class = "listitemClass"> 
          ...
          <br>
        <div id="imageNoc3ff00" class = "listitemClass"> 
...
kolejnosc = document.getElementById("outputvalues").value;
 grading = ["1fff00", "5eff00", "92ff00", "c3ff00", "f0ff00", "00ff92"];
...
document.getElementById("zestaw").value = "zestaw6";
