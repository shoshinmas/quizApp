...
<div class="height"></div>
    <div id = "imageListId"> 
         <div id="imageNo00ffc0" class = "listitemClass"> 
          ...
          <br>
        <div id="imageNo00ffa9" class = "listitemClass"> 
            <img src="img/zestaw1/00ffa9.png" alt=""> 00ffa9
        </div> 
          <br>
        <div id="imageNo00ff9e" class = "listitemClass"> 
		...
		<div id="imageNo00ffb5" class = "listitemClass"> 
...
kolejnosc = document.getElementById("outputvalues").value;
 grading = ["00ffcb", "00ffc0", "00ffb5", "00ffa9", "00ff9e", "00ff92"];
...
document.getElementById("zestaw").value = "zestaw1";
